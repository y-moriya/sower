...
<ul>
  ...
  <li><a href="#one">発言制限の1文字1発言の仕様について</a></li>
</ul>
<hr class="invisible_hr"$net>
...
<h3><a $atr_id="one">発言制限の1文字1発言の仕様について</a></h3>
<p class="paragraph">
1文字1発言村の仕様は以下の通りです。
<ul>
<li>村建て発言、管理人発言、傍観者発言、墓下発言、独り言<b>以外</b>の発言は1文字のみ発言できます。</li>
<li>プロローグ、エピローグも通常発言は1文字のみです。エピローグでは独り言を使うとよいでしょう。</li>
<li>通常発言は1日1回まで、狼の囁き、恋の囁き、共鳴発言、念話は1日2回までです。</li>
<li>アクションの使用回数は0です。</li>
</ul>
</p>
<hr class="invisible_hr"$net>
