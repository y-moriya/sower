...
sub GetConfig {
    ...
    # キャラクターセットID
    my @csidlist = ( 'rem', 'sow', 'troika', 'ao', 'wbbs10', 'mistyrain', 'troopers', 'tasyukoji', 'emoricu' );
    ...
    my @copyrights = (
        ...
        'Emoricu by <a href="https://yuchicatealatte.wixsite.com/milksugar">Yuchica</a>',
    );

    # キャッシュクリアのためファイル名に日付を入れた。
    my $lastupdate = '20241022';
