...
sub GetTextRS {
    ...
    my @announce_vote = (
        '_NAME_ は _TARGET_ に_RANDOM_投票してみた。',
        '_NAME_ に _COUNT_人が投票した（らしい）。',
        '_NAME_ は村人達によってたかってぶち殺された。'
    );

    my @announce_entrust = (
        '_NAME_は_TARGET_に_RANDOM_投票を任せて寝た。',
        '_NAME_は_TARGET_に_RANDOM_投票を任せて寝たが、投票先が変だったっぽい。',
    );

    # コミット
    my @announce_commit =
      ( '_NAME_が時間を進めるのを止めた。', '_NAME_は時間を進めたいらしい。', );
...
'<p>あなたは村中を混沌へと叩き込む事が三度の飯よりも大好きという、とても素晴らしい性格の持ち主です。誠心誠意を持って、村のために混乱を招きましょう。うへへへへへ☆<br>（イタズラっ子）</p>',
    ...
    my @actions = (
        'をハリセンで殴った。',                   'をパソコンで殴った。',
        'を鋼鉄製ハリセンで殴った。',          'をセラミックハリセンで殴った。',
        'をオリハルコンハリセンで殴った。', 'をぶっ飛ばした。',
        'にあっかんべーをした。',                'に手を振った。',
        'の頭を撫でた。',                            'を襲ってみた。',
        'を慰める振りをした。',                   'に求愛した。',
        'にむぎゅうした。',                         'に飴玉をぶん投げる振りをした。',
        'におじぎした。',
    );
    ...
    my %textrs = (
        ...
        ANNOUNCE_EPILOGUE =>
'_AVICTORY_全てのログとユーザー名を公開します。_DATE_ まで自由に書き込めますので、今回の感想などをどうぞ。',
        ...
        SETRANDOMTARGET =>
'_NAME_ は能力（_ABILITY_）の対象決定を天に任せた。天はいい加減に _TARGET_ に決めた。',
        ...
        EXECUTETRICKSTER =>
          '_NAME_ は、_TARGET1_ と _TARGET2_ をどうしようもない呪いにかけた。うへへへへ。',
        ...
        ANNOUNCE_CHANGESELROLE =>
          '_NAME_は、希望を _SELROLE_ に変更しました（他の人には見えません）。',
        ANNOUNCE_SETVOTE => 'せっかくだから、_NAME_ は _TARGET_ に投票するぜ！',
        ANNOUNCE_SETENTRUST =>
          'めんどくさい。<br><br>めんどくさいから、_NAME_ は _TARGET_ に投票任せた！',
        ANNOUNCE_SETTARGET =>
          '_NAME_ は、なんとなく _TARGET_ を能力（_ABILITY_）の対象に選んでみた。',
